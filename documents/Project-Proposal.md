...
The end user is the "Aesthetic Archivist"—collectors, design students, or enthusiasts who want to curate their lifestyle with intentionality. They will be able to analyze their collection to identify connections and view the history of their items.
...
Archival will utilize my experience with Angular, TypeScript, and web-app development. Additionally, I will get to use the web design experience I gained from my London internship at an art gallery. I was tasked with identifying design trends in galleries and museum's sites, and I can use this knowledge to develop a similar look for my app.
