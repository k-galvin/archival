...
- **PR 5 (Network Error Resilience):** If external APIs (Google, Discogs) fail to respond within **1.5 seconds**, the system shall implement a fallback logic that notifies the user and allows manual input without blocking the main thread.
